...
export const COLORS = {
  ...
  // Crystalline comet — amethyst color zoning kept from the quartz era: glowing icy
  // nucleus → violet settling shards → deep indigo finalized braid, with amber veil
  // inclusions (the same gold family as the validator cloud, so it belongs to its scene).
